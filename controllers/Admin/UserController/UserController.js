...
// ============================================================
// LIST ALL USERS (with optional filter by userType)
// Query: ?userType=1 or ?userType=2 or ?userType=3
// ============================================================
...
//     const filter = {};
//     if (userType) {
//       if (![1, 2, 3].includes(Number(userType))) {
//         return errorResponse(res, "Invalid userType filter. Use 1, 2, or 3.", null, 400);
//       }
//       filter.userType = Number(userType);
//     }

//     const users = await User.find(filter).select("-__v").lean();

//     const formatted = users.map((u) => ({
//       ...u,
//       userTypeLabel: USER_TYPE_LABELS[u.userType],
//     }));

//     const staff = formatted.filter((u) => u.userType === 1);
//     const teamHeads = formatted.filter((u) => u.userType === 2);
//     const owners = formatted.filter((u) => u.userType === 3);

//     return successResponse(res, "Users retrieved successfully", {
//       totalCount: formatted.length,
//       staffCount: staff.length,
//       teamHeadCount: teamHeads.length,
...
// // ============================================================
// // UPDATE USER
// // Body: { userName, userEmail, userType }
// // ============================================================
...
//     if (userType) updateData.userType = Number(userType);

//     const user = await User.findByIdAndUpdate(id, updateData, { new: true }).select("-__v");
//     if (!user) return errorResponse(res, "User not found", null, 404);
